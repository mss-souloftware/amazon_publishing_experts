...
const rows = [
  ...
  {
    speed: "animate-scroll-medium",   // 38s    (medium)
    direction: "rtl",
    books: [
  ...
  {
    speed: "animate-scroll-fast",      // 52s    (fast)
    direction: "ltr",
    books: [
    ...
    <section className="portfolio-showcase py-12 md:py-16 lg:py-20 bg-white overflow-hidden">
      <div className="container mx-auto px-4 md:px-8 lg:px-16">
        ...
        {rows.map((row, index) => (
          ...
          >
            {/* Optional subtle shelf background */}
            ...
            >
              {/* Duplicate books twice for seamless loop */}
      ...
      {/* Tailwind Animation Keyframes (add to your globals.css or tailwind.config) */}
      <style jsx global>{`
