...
const testimonials = [
  ...
  { name: 'David Davies', text: 'Their formatting service transformed my messy manuscript into a polished book I’m proud to share. Thank you for making the process so easy!' },
  { name: 'Raymond N', text: 'I’ve worked with several publishers, but Amazon Publishing Experts stands out as the best. My book’s sales have been fantastic.' },
  { name: 'Steve Jones', text: 'Excellent value for the quality of work. The team worked closely with me to stay within budget. Extremely satisfied!' },
];
...
export default function Testimonials() {
  return (
    <section
      id="testimonial"
      className="py-16 bg-gradient-to-b from-white to-gray-50 overflow-x-hidden"
    >
        ...
        <div className="grid lg:grid-cols-12 gap-10 items-start">
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <p className="text-gray-600 leading-relaxed">
              ...
              With our expertise and passion, we’re dedicated to supporting your success.
            </p>
...
function TestimonialCard({ name, text }: { name: string; text: string }) {
  return (
    <div className="bg-white p-6 rounded-xl shadow-lg border border-gray-100 hover:shadow-xl transition-shadow">
      <FaQuoteLeft className="text-3xl text-orange-500 mb-4 opacity-70" />
